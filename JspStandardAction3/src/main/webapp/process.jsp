...
<jsp:useBean id="dto" class='in.mypackage.dto.EmployeeDto' scope="request"/>
...
<jsp:useBean id="service" class='in.mypackage.service.SalaryDetailsGeneratorImpl' scope="application"/>
